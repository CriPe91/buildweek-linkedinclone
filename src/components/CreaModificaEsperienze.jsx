...
const CreaModificaEsperienze = () => {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault(); // Impedisce il comportamento predefinito del form (ricaricamento della pagina)
        ...
        <Col md={5}>
          ...
          <Form onSubmit={handleSubmit}>
            <Form.Group className="mb-3" controlId="formPlaintextEmail">
              ...
              />
              <Form.Label className="mt-3 fs-4">Data di inizio</Form.Label>
              <input type="text" className="form-control-plaintext" name="startDate" value={formData.startDate} onChange={handleChange} />
              <Form.Label className="mt-3 fs-4">Data di fine</Form.Label>
              <input type="text" className="form-control-plaintext" name="endDate" value={formData.endDate} onChange={handleChange} />
              <Form.Label className="mt-3 fs-4">Descrizione</Form.Label>
              <input
                type="text"
                className="form-control-plaintext"
